...
export interface Page {
  ...
  layout: (CallToActionBlock | ContentBlock | MediaBlock | ArchiveBlock | FormBlock | ExampleBlock | TableBlock)[];
  meta?: {
    title?: string | null;
    /**
...
export interface ExampleBlock {
  ...
  backgroundColor?: ('light' | 'dark' | 'blue' | 'green') | null;
...
export interface PagesSelect<T extends boolean = true> {
  ...
  layout?:
    ...
    | {
        ...
        example?: T | ExampleBlockSelect<T>;
